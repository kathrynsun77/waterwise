...
class _PaymentMethodsScreenState extends State<PaymentMethodsScreen> {
  ...
  fetchData() async {
    final response = await http.post(
      Uri.parse('http://192.168.1.13/water_wise/payment_method.php'),
      body: {
  ...
  deleteCard(String cardID) async {
    final response = await http.post(
      Uri.parse('http://192.168.1.13/water_wise/delete_card.php'),
      body: {
        'card-id': cardID,
        'cust-id': user['customer_id'],
      },
  ...
  void addPayment() async {
    var url = 'http://192.168.1.13/water_wise/add_payment.php';
  ...
  void setDefaultCard(String cardID) async {
    var url = 'http://192.168.1.13/water_wise/set_default_card.php';
    var response = await http.post(Uri.parse(url), body: {
      'card-id': cardID,
      'cust-id': user['customer_id'],
    });
